...
fpm --verbose -s dir -t deb -n horizon --version 0.0.3 --iteration 1 --description "Digitalbits-horizon" $GOPATH/bin/horizon=/usr/local/bin/horizon
...
fpm --verbose -s dir -t rpm -n horizon --version 0.0.3 --iteration 1 --description "Digitalbits-horizon" $GOPATH/bin/horizon=/usr/local/bin/horizon
...
ls
cloudsmith push deb digitalbits/dbtest/ubuntu/trusty horizon_0.0.3-1_amd64.deb
...
cloudsmith push rpm digitalbits/dbtest/el/7 horizon-0.0.3-1.x86_64.rpm

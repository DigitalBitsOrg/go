...
- network:  Added the `HashTransaction` helper func to get the hash of a transaction targetted to a specific digitalbits network.

### Changed:

- build: _BREAKING CHANGE_:  A transaction built and signed using the `build` package no longer default to the test network.

[Unreleased]: https://github.com/digitalbitsorg/go/commits/master
...
// Client represents a client that is capable of resolving a digitalits.toml file
// using the internet.
type Client struct {
...
// GetStellarTomlByAddress returns digitalbits.toml file of a domain fetched from a
// given address

...
// LoadAccount loads the account state from frontier. err can be either error
// object or frontier.Error object.
...
// LoadAccountOffers loads the account offers from frontier. err can be either
// error object or frontier.Error object.

...
// encodes it into a base64 string capable of being submitted to digitalbits-core.
//
...
// encodes the transaction into a base64 string capable of being submitted to digitalbits-core. It uses
...
// being submitted to digitalbits-core. It uses the transaction builder system.
func ExamplePayment() {
	seed := "SDBNWCXQ6JTYG2SI6373PAUQXH2LYSZWKCXK262FAWHAG4MIHND3HCOL"
	tx, err := Transaction(
		SourceAccount{seed},

...
* `digitalbits`
  ...
  * `horizon` - URL to [horizon](https://github.com/digitalbitsorg/go/tree/master/services/horizon) server
...
* Deploy at least 2 bifrost, bitcoin-core, geth, digitalbits-core and horizon servers. Use multi-AZ database.
* Do not use the DigitalBits Foundation's horizon servers. There is no SLA and we cannot guarantee it will handle your load.

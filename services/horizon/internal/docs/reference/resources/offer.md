...
Accounts on the DigitalBits network can make [offers](http://developer.digitalbits.io/learn/concepts/exchange.html) to buy or sell assets.  Users can create offers with the [Manage Offer](http://developer.digitalbits.io/learn/concepts/list-of-operations.html) operation.

...
To learn more about the concept of transactions in the DigitalBits network, take a look at the [DigitalBits transactions concept guide](https://developers.digitalbits.io/learn/concepts/transactions.html).

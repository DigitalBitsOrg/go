...
Trades can also be caused by successful [path payments](https://developer.digitalbits.io/learn/concepts/exchange.html), because path payments involve fulfilling offers.

...
| [PATH_PAYMENT](#path-payment)                 | 2      | Sends a path payment between two accounts in the DigitalBits network.
| [MANAGE_OFFER](#manage-offer)                 | 3      | Creates, updates or deletes an offer in the DigitalBits network.

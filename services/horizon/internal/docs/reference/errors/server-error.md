...
If you are encountering this error on the public DigitalBits infrastructure, please report an error on [Horizon's issue tracker](https://github.com/digitalbitsorg/go/issues) and include the instance attribute.
...
```json
{
  "type":     "https://developer.digitalbits.io/docs/horizon/problems/server_error",
  "title":    "Internal Server Error",
  "status":   500,
  "details":  "...",

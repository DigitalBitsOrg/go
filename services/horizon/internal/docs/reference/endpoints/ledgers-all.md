...
title: All Ledgers
clientData:
  laboratoryUrl: https://developer.digitalbits.io/lab/#explorer?resource=ledgers&endpoint=all
---

This endpoint represents all [ledgers](../resources/ledger.md).
This endpoint can also be used in [streaming](../responses.md#streaming) mode so it is possible to use it to get notifications as ledgers are closed by the DigitalBits network.
...
curl "https://horizon.testnet.digitalbits.io/ledgers?limit=200&order=desc"
```

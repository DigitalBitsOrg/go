...
clientData:
  laboratoryUrl: https://developer.digitalbits.io/lab/#explorer?resource=data&endpoint=for_account
---
...
```sh
curl "https://horizon.testnet.digitalbits.io/accounts/GA2HGBJIJKI6O4XEM7CZWY5PS6GKSXL6D34ERAJYQSPYA6X6AI7HYW36/data/user-id"
```

...
GOTOP="$( cd "$DIR/../../../../../../../.." && pwd )"
PACKAGES=$(find $GOTOP/src/github.com/digitalbitsorg/go/services/horizon/internal/test/scenarios -iname '*.rb' -not -name '_common_accounts.rb')
# PACKAGES=$(find $GOTOP/src/github.com/stellar/go/services/horizon/internal/test/scenarios -iname 'kahuna.rb')

go install github.com/digitalbitsorg/go/services/horizon
...
go generate github.com/digitalbitsorg/go/services/horizon/internal/test/scenarios

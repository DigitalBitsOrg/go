...
GOTOP="$( cd "$DIR/../../../../../../../.." && pwd )"
go generate github.com/digitalbitsorg/go/services/frontier/internal/db2/schema
go install github.com/digitalbitsorg/go/services/frontier
dropdb horizon_schema --if-exists
createdb horizon_schema
DATABASE_URL=postgres://localhost/horizon_schema?sslmode=disable $GOTOP/bin/frontier db migrate up
...
go generate github.com/digitalbitsorg/go/services/frontier/internal/db2/schema
go generate github.com/digitalbitsorg/go/services/frontier/internal/test
go install github.com/digitalbitsorg/go/services/frontier

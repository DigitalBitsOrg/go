...
GOTOP="$( cd "$DIR/../../../../../../../.." && pwd )"
PACKAGES=$(find $GOTOP/src/github.com/digitalbitsorg/go/services/frontier/internal/test/scenarios -iname '*.rb' -not -name '_common_accounts.rb')
# PACKAGES=$(find $GOTOP/src/github.com/stellar/go/services/frontier/internal/test/scenarios -iname 'kahuna.rb')
...
for i in $PACKAGES; do
  ...
  $GOTOP/bin/frontier db reingest
...
go generate github.com/digitalbitsorg/go/services/frontier/internal/test/scenarios
# go test github.com/stellar/go/services/frontier/internal/ingest

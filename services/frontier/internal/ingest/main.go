// Package ingest contains the ingestion system for frontier.  This system takes
// data produced by the connected digitalbits-core database, transforms it and
// inserts it into the frontier database.
package ingest
...
// New initializes the ingester, causing it to begin polling the digitalbits-core

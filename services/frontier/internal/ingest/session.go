...
import (
	...
	"github.com/digitalbitsorg/go/services/frontier/internal/ingest/participants"
	"github.com/digitalbitsorg/go/support/errors"
	sTime "github.com/digitalbitsorg/go/support/time"
...
// reportCursorState makes an http request to the configured digitalbits-core server
// to report that it has finished processing the data being ingested.  This
// allows digitalbits-core to free that storage when next it runs its own
// maintenance.

...
import (
	...
	herr "github.com/digitalbitsorg/go/services/frontier/internal/errors"
...
// ClearAll removes all previously ingested historical data from the frontier
// database.
...
// RebaseHistory re-establishes frontier's history database using the provided
...
// frontier but is no longer present in the digitalbits-core database source.  The
...
// within frontier.  It ensures the ledger at `seq` is a child of `seq - 1`.

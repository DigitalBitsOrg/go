...
// GetAddress retrieves a digitalbits address.  It confirms the value loaded is a
// valid digitalbits address, setting an invalid field error if it is not.
...
// the string at the provided name in accordance with the digitalbits client
// conventions

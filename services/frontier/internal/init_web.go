...
// Web contains the http server related fields for frontier: the router,
// rate limiter, etc.
type Web struct {
	router      *web.Mux
...
// initWebMiddleware installs the middleware stack used for frontier onto the
// provided app.
...
// initWebActions installs the routing configuration of frontier onto the

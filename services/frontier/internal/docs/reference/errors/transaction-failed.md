...
As with all errors Frontier returns, `transaction_failed` follows the [Problem Details for HTTP APIs](https://tools.ietf.org/html/draft-ietf-appsawg-http-problem-00) draft specification guide and thus has the following attributes:
...
```json
{
  "type":     "https://developer.digitalbits.io/frontier/reference/errors/transaction-failed.html",
  "title":    "Transaction Failed",
  "status":   400,
  "details":  "...",

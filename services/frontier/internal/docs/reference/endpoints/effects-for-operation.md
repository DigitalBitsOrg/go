...
clientData:
  laboratoryUrl: https://developer.digitalbits.io/lab/#explorer?resource=effects&endpoint=for_operation
---
...
```sh
curl "https://frontier.testnet.digitalbits.io/operations/77309415424/effects"
```

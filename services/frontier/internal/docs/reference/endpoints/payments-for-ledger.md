...
clientData:
  laboratoryUrl: https://developer.digitalbits.io/lab/#explorer?resource=payments&endpoint=for_ledger
---
...
```sh
curl "https://frontier.testnet.digitalbits.io/ledgers/69859/payments"
```

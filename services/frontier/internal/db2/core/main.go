...
// reading rows from a digitalbits Core db
package core
...
// Q is a helper struct on which to hang common queries against a digitalbits
// core database.
type Q struct {
	*db.Session
}
...
// digitalbits-core database this ingestion system is communicating with.  Frontier,

...
import (
	...
	"github.com/digitalbitsorg/go/services/frontier/internal/db2/schema"
...
var dbBackfillCmd = &cobra.Command{
	Use:   "backfill [COUNT]",
	Short: "backfills frontier history for COUNT ledgers",
...
var dbRebaseCmd = &cobra.Command{
	Use:   "rebase [SEQUENCE]",
	Short: "rebases frontier history at ledger SEQUENCE",
	Long:  "rebases clears the frontier history db and ingests the ledger at SEQUENCE",
	Run: func(cmd *cobra.Command, args []string) {
		initConfig()
		hlog.DefaultLogger.Logger.Level = config.LogLevel
